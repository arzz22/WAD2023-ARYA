...
// silakan taruh code kalian di baw
if(empty($error)) {
...
<body>
    <div class="row">
        ...
        <?php
        if(isset($bmi)) {
            echo "<h4>Hasil Perhitungan BMI</h4>";
            echo "BMI Anda adalah: " . $bmi;
            echo "\n\n";

            if($bmi <= 18.4){
                echo "dan Anda Underweight";
            }elseif($bmi <= 24.9 && $bmi >= 18.5){
                echo "dan Anda Normal";
            }elseif($bmi <= 39.9 && $bmi >= 25.0){
                echo "dan Anda Overweight";
            }elseif($bmi >= 40){
                echo "dan Anda Obese";
            }else{
                echo "Status Anda Tidak ditemukan";
            }
        }
        ?>
